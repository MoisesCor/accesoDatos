...
public class portatiles extends ordenadores {
    ...
    public portatiles(String paramRam, String paramCpu, double paramPrecio, String paramCodigo, double paramPeso) {
        super(paramRam, paramCpu, paramPrecio,paramCodigo);
