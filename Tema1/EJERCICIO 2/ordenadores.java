...
public abstract class  ordenadores {
    ...
    /*Contstruztor*/
    public ordenadores(String paramRam, String paramCpu, double paramPrecio, String paramCodigo) {
        this.sRam = paramRam;
        this.sCpu = paramCpu;
    ...
    public void getCaracterisiticas(){
        System.out.println("Código "+this.sCodigo);
    ...
    public String toString() {
        return "ordenadores [dPrecio=" + dPrecio + ", sCpu=" + sCpu + ", sRam=" + sRam +" Código="+sCodigo+ "]";
    }
